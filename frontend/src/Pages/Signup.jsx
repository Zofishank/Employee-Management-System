...
/* ── Shared left-panel brand content ── */
const BrandPanel = () => (
    ...
    <div className="relative z-10 flex flex-col items-center text-center gap-8 px-12">
      ...
      >
        ...
        <p className="text-sm text-white/40 max-w-xs leading-relaxed">
          Tasks · AI Assistant · Admin Chat · Progress Tracking · Notifications
        </p>
      </motion.div>
...
const Signup = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // Fixed: Added error parameter and proper error handling
      ...
      >
        ...
        >
          ...
          <div className="flex flex-col gap-1">
            <h2 className="text-2xl font-bold text-white/95">Create account</h2>
            <p className="text-sm text-white/35">
              Join WorkHub and manage your tasks efficiently
            </p>
          </div>
