...
/* ── Nav defined as plain objects with string icon keys ──
   Icons rendered explicitly in JSX to avoid dynamic component errors */
const NAV_SECTIONS = [
  {
    title: "Tasks",
    items: [
...
/* Render icon by string key — avoids dynamic component reference errors */
